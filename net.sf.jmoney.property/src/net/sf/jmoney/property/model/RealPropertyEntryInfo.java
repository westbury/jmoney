...
public class RealPropertyEntryInfo implements IPropertySetInfo {
	...
	private static ExtensionPropertySet<RealPropertyEntry,Entry> propertySet = PropertySet.addExtensionPropertySet(RealPropertyEntry.class, EntryInfo.getPropertySet(), new IExtensionObjectConstructors<RealPropertyEntry,Entry>() {

		public RealPropertyEntry construct(Entry extendedObject) {
	 ...
	 * @return
	 */
	public static ExtensionPropertySet<RealPropertyEntry,Entry> getPropertySet() {
		return propertySet;
	}
