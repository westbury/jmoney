 ...
 */
public class OfxExportWizardPage extends WizardPage  {

	private static final String OFX_EXPORT_WIZARD_PAGE = "ofxExportWizardPage"; //$NON-NLS-1$
	 ...
	 */
	protected OfxExportWizardPage(IWorkbenchWindow window) {
		super(OFX_EXPORT_WIZARD_PAGE);
		this.window = window;
		setTitle("Choose File");
		setDescription("Choose the name of the OFX file to export to");
	}
	...
	public void createControl(Composite parent) {
		...
		label.setText(
				"The account will be exported to the given OFX file.");
		GridData gd = new GridData(SWT.FILL, SWT.FILL, true, true);
		gd.horizontalSpan = 2;
		gd.widthHint = 600;
		label.setLayoutData(gd);
		
		setDescription("Export data to an OFX file on your local file system.");
	...
	protected void browsePressed() {
		...
		fileChooser.setText(Activator.getResourceString("MainFrame.export"));
		fileChooser.setFilterExtensions(new String[] { "*.ofx" });
		fileChooser.setFilterNames(new String[] { "Open Financial Exchange (*.ofx)" });
