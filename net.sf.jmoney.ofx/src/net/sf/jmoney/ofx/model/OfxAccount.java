 ...
 */
public class OfxAccount extends CapitalAccountExtension {
	 ...
	 */
	public OfxAccount(ExtendableObject extendedObject) {
	...
	public void setImportDataExtensionId(String importDataExtensionId) {
		...
		this.importDataExtensionId = importDataExtensionId;
		processPropertyChange(OfxAccountInfo.getImportDataExtensionIdAccessor(), oldImportDataExtensionId, importDataExtensionId);
	}
