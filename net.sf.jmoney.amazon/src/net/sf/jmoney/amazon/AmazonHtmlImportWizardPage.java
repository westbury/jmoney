 ...
 */
public class AmazonHtmlImportWizardPage extends WizardPage  {
	 ...
	 */
	protected AmazonHtmlImportWizardPage(IWorkbenchWindow window) {
		super(NAME);
		this.window = window;
	...
	protected void browsePressed() {
		...
		fileChooser.setText("Amazon HTML Import");
		fileChooser.setFilterExtensions(new String[] { "*.html", "*.htm" });
		fileChooser.setFilterNames(new String[] { "Web Pages (*.html)", "Web Pages (*.htm)" });
