...
/**
 * Wizard page that asks for the location of one or more PDF files.
 */
public class PdfImportWizardPage extends WizardPage  {

	private static final String NAME = "pdfImportWizardPage"; // //$NON-NLS-1$
	 ...
	 */
	public PdfImportWizardPage(IWorkbenchWindow window, String description) {
		super(NAME);
		this.window = window;
		this.description = description;
		setTitle("Choose File");
		setDescription("Import data from PDF files");
	}
	...
	protected void browsePressed() {
		...
		fileChooser.setFilterNames(new String[] { "Portable Document Format (*.pdf)" });
