...
public class ImportAccountInfo implements IPropertySetInfo {
	...
	private static ExtensionPropertySet<ImportAccount,CapitalAccount> propertySet = PropertySet.addExtensionPropertySet(ImportAccount.class, CapitalAccountInfo.getPropertySet(), new IExtensionObjectConstructors<ImportAccount,CapitalAccount>() {

		@Override
		public ImportAccount construct(CapitalAccount extendedObject) {
...
//			}
	 ...
	 * @return
	 */
	public static ExtensionPropertySet<ImportAccount,CapitalAccount> getPropertySet() {
		return propertySet;
	}
