 ...
 */
class ObjectList_Filter implements IObjectList {
	ObjectList_ListProperty parentItemList;
	ExtendablePropertySet<?> filterOnClass = null;

	public ObjectList_Filter(ObjectList_ListProperty parentItemList, ExtendablePropertySet<?> filterOnClass) {
	...
	public void save(IMemento memento) {
		/*
		 * Merge the filter into the parent element.
		 */
		parentItemList.save(memento, filterOnClass);
	}
