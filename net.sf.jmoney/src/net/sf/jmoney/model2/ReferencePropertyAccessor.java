...
public abstract class ReferencePropertyAccessor<V extends ExtendableObject,E extends ExtendableObject> extends ScalarPropertyAccessor<V,E> implements IReferencePropertyAccessor<V,E> {
	...
	public ReferencePropertyAccessor(Class<V> classOfValueObject, PropertySet<?,E> propertySet, String localName, String displayName, int weight, int minimumWidth, final IPropertyControlFactory<V> propertyControlFactory, IPropertyDependency<E> propertyDependency) {
