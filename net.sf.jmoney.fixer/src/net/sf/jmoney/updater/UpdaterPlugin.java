...
public class UpdaterPlugin extends AbstractUIPlugin {
	...
	public UpdaterPlugin() {
		...
		plugin = this;
		try {
			resourceBundle = ResourceBundle.getBundle("net.sf.jmoney.updater.CopierPluginResources");
	...
	public static String getResourceString(String key) {
		ResourceBundle bundle = UpdaterPlugin.getDefault().getResourceBundle();
		try {
